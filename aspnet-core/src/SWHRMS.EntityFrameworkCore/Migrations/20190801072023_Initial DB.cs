        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    PositionName = table.Column<string>(maxLength: 250, nullable: true),
                    Description = table.Column<string>(nullable: true),
                    IsActive = table.Column<bool>(nullable: false),
                    CreationTime = table.Column<DateTime>(nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    InfoName = table.Column<string>(maxLength: 250, nullable: true),
                    Description = table.Column<string>(nullable: true),
                    IsActive = table.Column<bool>(nullable: false),
                    CreationTime = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserMetaInfos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressTemporal = table.Column<string>(nullable: true),
                    AccGit = table.Column<string>(nullable: true),
                    AccRedmine = table.Column<string>(nullable: true),
                    SocialInsuranceNo = table.Column<string>(nullable: true),
                    PositionId = table.Column<int>(nullable: true),
                    BranchId = table.Column<int>(nullable: true),
                    DaysAbsent = table.Column<int>(nullable: true),
                    Devices = table.Column<string>(maxLength: 1000, nullable: true),
                    Platform = table.Column<string>(maxLength: 20, nullable: true),
                    LastLogin = table.Column<DateTime>(nullable: true),
                    RequestPasswordHash = table.Column<string>(maxLength: 199, nullable: true),
                    RequestExpired = table.Column<string>(maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Absence_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationTime = table.Column<DateTime>(nullable: false),
                    UserId = table.Column<long>(nullable: false),
                    UserMetaInfoId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserMetaInfoDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserMetaInfoDetails_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserMetaInfoDetails_UserMetaInfos_UserMetaInfoId",
                        column: x => x.UserMetaInfoId,
                        principalTable: "UserMetaInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserMetaInfoDetails_UserId",
                table: "UserMetaInfoDetails",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserMetaInfoDetails_UserMetaInfoId",
                table: "UserMetaInfoDetails",
                column: "UserMetaInfoId");
        }
